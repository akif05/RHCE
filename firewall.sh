...
firewall-cmd --permanent --direct --add-rule ipv4 filter FORWARD 0 -s 192.168.11.0/24 j ACCEPT
firewall-cmd --permanent --direct --add-rule ipv4 filter FORWARD 0 -s 192.168.22.0/24 j ACCEPT
